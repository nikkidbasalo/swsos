...
export default function EvaluateModal({ hideModal, grantee }: ModalProps) {
  ...
  useEffect(() => {
    ;(async () => {
      const result = await fetchGrades(grantee.user?.id, 999, 0)
                            ...
                            <div className="space-y-1">
                              <div>
                                ...
                                <span className="font-bold">
                                  {grantee.user?.id_number}
                                </span>
                              </div>
                              <div>
                                <span className="">Fullname:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.lastname},{' '}
                                  {grantee.user?.firstname}{' '}
                                  {grantee.user?.middlename}
                                </span>
                              </div>
                              <div>
                                <span className="">Year Granted:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.year_granted}
                                </span>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <span className="font-bold">
                                  {grantee.user?.employee_number}
                                </span>
                              </div>
                              <div>
                                <span className="">Function:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.function}
                                </span>
                              </div>
                              <div>
                                <span className="">Control No:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.control_number}
                                </span>
                              </div>
                              <div>
                                <span className="">TES Award Number</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.tes_award_number}
                                </span>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-2 py-2 font-light">
                            <div className="space-y-1">
                              ...
                              <div>
                                ...
                                <span className="font-bold">
                                  {grantee.user?.birthday}
                                </span>
                              </div>
                              <div>
                                <span className="">Degree Program:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.degree_program}
                                </span>
                              </div>
                              <div>
                                <span className="">Year level:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.year_level_status}
                                </span>
                              </div>
                              <div>
                                <span className="">Remarks:</span>{' '}
                                <span className="font-bold">
                                  {grantee.user?.remarks}
                                </span>
                              </div>
                            </div>
                          </td>
